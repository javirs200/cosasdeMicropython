...
class Device:
    ...
    def start(self):
        while True:
            # Read pin pwm values and update variables and log values into console
            self.x = time_pulse_us(self.pin_X, 1, 1000000)
            self.y = time_pulse_us(self.pin_Y, 1, 1000000)
